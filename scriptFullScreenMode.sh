...
# Function to check and enforce kiosk-like mode on a specific display
check_display() {
    local DISPLAY_ID=$1
    ...
    # Get Chrome windows on this display
    ...
    # Send F11 only to windows that are not already fullscreen
